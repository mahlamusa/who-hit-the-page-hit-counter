...
if ( $total > 0 ) : ?>    
	...
	<table class="table-responsive mdl-data-table mdl-js-data-table mdl-shadow--2dp">
		<thead>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Visitor\'s  IP', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Visits', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'User Agent', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( '1st Visit', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Last Visit', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Actions', 'whtp' ); ?></th>
		</thead>
		<tbody  id="ips-table">        
				...
				<td>						
					...
					<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
						...
						<li class="mdl-menu__item">
							<a class="confirm-delete" href="<?php echo admin_url( 'admin.php?page=whtp-view-ip-hits&delete_ip=this_ip&ip_address=' . $row->ip_address . '&nonce=' . $nonce ); ?>"><?php es_attr_e( 'Delete This IP', 'whtp' ); ?></a>
						</li>
						<li class="mdl-menu__item">
							<a class="confirm-ignore" href="<?php echo admin_url( 'admin.php?page=whtp-view-ip-hits&deny_ip=this_ip&ip_address=' . $row->ip_address . '&nonce=' . $nonce ); ?>"><?php es_attr_e( 'Ignore Counts', 'whtp' ); ?></a>
						</li>
						<li class="mdl-menu__item">
							<a class="confirm-reset" href="<?php echo admin_url( 'admin.php?page=whtp-view-ip-hits&reset_ip=this_ip&ip_address=' . $row->ip_address . '&nonce=' . $nonce ); ?>"><?php es_attr_e( 'Reset IP', 'whtp' ); ?></a>
						</li>
					</ul>
				</td>
			</tr>
		...
		<tfoot>
			<tr>
				<td class="title-footer mdl-data-table__cell--non-numeric" colspan="5" align="right">
					<h4><?php es_attr_e( 'Total unique IP´s', 'whtp' ); ?></h4>
				</td>
			...
			<tr>
				...
				<td class="title-footer ipv-title">
					<form action="" method="post">
						...
						<input type="submit" name="submit" value="<?php es_attr_e( 'Reset All', 'whtp' ); ?>" class="button-primary confirm-reset" />
					</form>
				</td>
				<td class="title-footer ftime-title">
					<form action="" method="post">
						...
						<input type="submit" name="submit" value="<?php es_attr_e( 'Delete All', 'whtp' ); ?>" class="button confirm-delete" />
					</form>
				</td>	
			</tr>
		</tfoot>        
