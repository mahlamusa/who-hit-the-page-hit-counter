...
if ( $total > 0 ) : ?>
	...
	<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
		<thead>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Page Visited', 'whtp' ); ?></th>
			<th><?php es_attr_e( 'Number of Hits', 'whtp' ); ?></th>
			<th class="mdl-data-table__cell--non-numeric"><?php es_attr_e( 'Discount By', 'whtp' ); ?></th>
			<th><?php es_attr_e( 'Actions', 'whtp' ); ?></th>
		</thead>
		<tbody id="hits-table">        
				...
				<td>						
					...
					<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
						...
						<li class="mdl-menu__item">
							<a class="confirm-delete" href="<?php echo admin_url( 'admin.php?page=whtp-view-page-hits&delete_page=delete&page_id=' . $row->page_id . '&nonce=' . $nonce ); ?>"><?php es_attr_e( 'Delete', 'whtp' ); ?></a>
						</li>
						<li class="mdl-menu__item">
							<a class="confirm-reset" href="<?php echo admin_url( 'admin.php?page=whtp-view-page-hits&reset_page=reset&page_id=' . $row->page_id . '&nonce=' . $nonce ); ?>"><?php es_attr_e( 'Reset', 'whtp' ); ?>
							</a>
						</li>
					</ul>
				</td>
		...
		<tfoot>
			<tr>
				<td colspan="2">&nbsp;</td>
				<td class="mdl-data-table__cell--non-numeric"><h4><?php es_attr_e( 'Total Hits', 'whtp' ); ?></h4></td>
	...
	<?php else : ?>
		<div id="welcome-panel" class="welcome-panel">
			<h4 class="handle">
				<?php es_attr_e( 'No Data Found', 'whtp' ); ?>
			</h4>
			<p>
				<?php es_attr_e( 'No Page visits yet or the page counters have been reset. Read documentation to learn how to get started', 'whtp' ); ?>
			</p>
		</div>          
		<?php
	endif;
