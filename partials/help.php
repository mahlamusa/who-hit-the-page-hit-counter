...
<div class="wrap">	
    ...
    <div class="mdl-color--white mdl-cell mdl-cell--12-col">
        <div class="whtp-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col">
            ...
            <div class="mdl-card__actions mdl-card--border">
                <a href="http://whohit.co.za/who-hit-the-page-hit-counter" target="_blank" class="mdl-button mdl-js-button mdl-js-ripple-effect"><?php _e( 'Read More', 'whtp' ); ?></a>
            </div>
        </div>  
    </div>
    ...
    <div class="mdl-color--white mdl-cell mdl-cell--12-col">
        <div class="whtp-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col">
            ...
            <div class="mdl-card__supporting-text mdl-color-text--grey-600">                
                <p><?php _e( 'The hits per page are shown on the first table, and the visitor\'s IP addresses are shown on the last table. Place the following shortcode snippet in any page or post you wish visitors counted on.', 'whtp' ); ?></p>
                <p><?php _e( '[whohit]-Page name or identifier-[/whohit]</code> <br />- please remember to replace the `<code>-Page name or identifier-</code>` with the name of the page you placed the shortcode on, if you like you can put in anything you want to use as an identifier for the page.', 'whtp' ); ?><code></p>
                <p><?php _e( 'For example: On our <a href="https://whohit.co.za/about-us">about us page</a> we placed <code>[whohit]About Us[/whohit]</code> and on our <a href="https://whohit.co.za/web-hosting">web hosting</a> page we placed <code>[whohit]Web Hosting[/whohit]</code>. Please note that what you put between [whohit] and [/whohit] doesn\'t need to be the same as the page name - that means; for our <a href="https://whohit.co.za/web-design-and-development">website design and development page</a> we can use <code>[whohit]Development[whohit]</code> instead of the whole <code>[whohit]website design and development page[whohit]</code> string, its completely up to you what you put as long as you will be able to see it on your admin what page has how many visits.', 'whtp' ); ?></p>
                <p><?php _e( 'Please make sure you place the shortcode <code>[whohit]..[/whohit]</code> only once in a page or post, if you place it twice, that page will be counted twice and thats not what you want. If you don\'t put anything between the inner square brackets of the shortcode, like so:<code>[whohit][/whohit]</code>, then you will have an unknown page appering with a count on the hits table and you will not know what page that is on your website.', 'whtp' ); ?></p>
                <p><?php _e( 'Please link to our website if you like our plugin, we really appreciate your kind gesture. Visit our website at https://whohit.co.za/', 'whtp' ); ?></p>
                <p><?php _e( 'Please copy and paste this: <code>[supportlink]</code> on any page or post in visual view to display the link shown above.', 'whtp' ); ?></p>
            </div>
            <div class="mdl-card__actions mdl-card--border">
