...
# 16. Move /trunk/assets/repo up to /assets.
...
CURRENTDIR=$(pwd)
default_svnpath="/tmp/who-hit-the-page-hit-counter"
default_svnurl="https://plugins.svn.wordpress.org/who-hit-the-page-hit-counter"
default_svnuser="mahlamusa"
default_plugindir="$CURRENTDIR/who-hit-the-page-hit-counter"
default_mainfile="who-hit-the-page.php"
...
if [ ! -f "$PLUGINDIR/who-hit-the-page.php" ]; then
  echo "Plugin file $PLUGINDIR/who-hit-the-page.php not found. Aborting."
  exit 1;
fi
...
PLUGINVERSION=$(grep -i "Version:" $PLUGINDIR/who-hit-the-page.php | awk -F' ' '{print $NF}' | tr -d '\r')
echo "who-hit-the-page.php version: $PLUGINVERSION"
READMEVERSION=$(grep -i "Stable tag:" $PLUGINDIR/readme.txt | awk -F' ' '{print $NF}' | tr -d '\r')
echo "readme.txt version: $READMEVERSION"

if [ "$READMEVERSION" = "trunk" ]; then
	echo "Version in readme.txt & who-hit-the-page.php don't match, but Stable tag is trunk. Let's continue..."
elif [ "$PLUGINVERSION" != "$READMEVERSION" ]; then
	echo "Version in readme.txt & who-hit-the-page.php don't match. Exiting...."
	exit 1;
elif [ "$PLUGINVERSION" = "$READMEVERSION" ]; then
	echo "Versions match in readme.txt and who-hit-the-page.php. Let's continue..."
fi
...
echo
echo "Slug: who-hit-the-page-hit-counter"
echo "Plugin directory: $PLUGINDIR"
echo "Main file: who-hit-the-page.php"
...
mv $SVNPATH/trunk/assets/repo-assets/* $SVNPATH/assets/
svn add --force $SVNPATH/assets/
svn delete --force $SVNPATH/trunk/assets/repo-assets
...
svn delete --force --quiet $SVNPATH/tags/$PLUGINVERSION/assets/repo-assets
